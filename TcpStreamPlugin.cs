...
{
    public class TcpStreamPlugin : MissionPlanner.Plugin.Plugin
    {
        ...
        private string _Name = "GPS Data Sender Plugin";
        private string _Version = "1.0";
        private string _Author = "Robin Dade";
        ...
        public static TcpStream.ServerView serverWindow { get; set; } = null;
        ...
        public override bool Loaded()
        {
            ...
            System.Windows.Forms.ToolStripMenuItem item = new System.Windows.Forms.ToolStripMenuItem() { Text = "Server Connection" };
        ...
        void item_Click(object sender, EventArgs e)
        {
            ...
            {
                if (frm is TcpStream.ServerView)
                {
                    formExist = true;
                }
            }
            ...
            if (!formExist)
            {
                TcpStream.ServerView form = new TcpStream.ServerView();
                form.Show();
            }
        }
        ...
        public static void changeIP(String ip, String username)
        {
            if (PingHost(ip))
            {
                ...
                try
                {
                    TcpStream.AsynchronousClient.StartClient(ip);
